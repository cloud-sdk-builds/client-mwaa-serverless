...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FfVBO/KAZCFNwM9DJSYmz6tsDWrVQz782mH07O7n2DA7CEhVU5e1CKKUFiLz2Cjo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.956.0/index.min.mjs": "sha384-FfVBO/KAZCFNwM9DJSYmz6tsDWrVQz782mH07O7n2DA7CEhVU5e1CKKUFiLz2Cjo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.956.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5XEwk9VIg8pmPSHjJUM47PgOVUkaBzDj+nTh5UKgHV3H26NWKe0w11QxPVTPHeF+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.972.0/index.min.mjs": "sha384-5XEwk9VIg8pmPSHjJUM47PgOVUkaBzDj+nTh5UKgHV3H26NWKe0w11QxPVTPHeF+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.972.0/LICENSE
```

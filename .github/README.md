...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-acLZQv4Jrc74rt28nrwomfBQo/GSN7CDCgee15CyrsNQmF0kTlQX9kGFXxfvSn8Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.995.0/index.min.mjs": "sha384-acLZQv4Jrc74rt28nrwomfBQo/GSN7CDCgee15CyrsNQmF0kTlQX9kGFXxfvSn8Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.995.0/LICENSE
```

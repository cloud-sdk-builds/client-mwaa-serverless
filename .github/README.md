...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-niee09Z+88VITmdqpO4bLtHjPzbLjdF+boFLihz3baG8u/4l+vGJyzMoB5rbd8M1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.975.0/index.min.mjs": "sha384-niee09Z+88VITmdqpO4bLtHjPzbLjdF+boFLihz3baG8u/4l+vGJyzMoB5rbd8M1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.975.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.953.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.953.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7q04RBk/1yU1Y3KmFp/C+5NoiEArlWbu2Ghx8xa5+vdFR9yd7unMmLJPXMD6rQn1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.953.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.953.0/index.min.mjs": "sha384-7q04RBk/1yU1Y3KmFp/C+5NoiEArlWbu2Ghx8xa5+vdFR9yd7unMmLJPXMD6rQn1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.953.0/LICENSE
```

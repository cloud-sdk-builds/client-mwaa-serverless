...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4ZSTn8CNxBTMICPikdrRtNPoU7dNh/E9I2aI6UIB91G3v2eFk/c3KUWvKt1CNr3J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.957.0/index.min.mjs": "sha384-4ZSTn8CNxBTMICPikdrRtNPoU7dNh/E9I2aI6UIB91G3v2eFk/c3KUWvKt1CNr3J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.957.0/LICENSE
```

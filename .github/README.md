...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.1039.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1039.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XZqoJdCzI0KTxuZUxqKsQaHNm1l0i0tge5Gzx3ANgPOmxxajddF5459IkldPYuto
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1039.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1039.0/index.min.mjs": "sha384-XZqoJdCzI0KTxuZUxqKsQaHNm1l0i0tge5Gzx3ANgPOmxxajddF5459IkldPYuto"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.1039.0/LICENSE
```

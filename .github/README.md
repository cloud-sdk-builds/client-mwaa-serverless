...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Dsj98TzzE61lA2tWRes8rkGq9Q15+fAsB4zyyTEkHJpUFWEULUzoOL5DblW9Fk8G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.999.0/index.min.mjs": "sha384-Dsj98TzzE61lA2tWRes8rkGq9Q15+fAsB4zyyTEkHJpUFWEULUzoOL5DblW9Fk8G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.999.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v3YxE3TXkYFAsvFYjk7eWMGUdJ4VPvhDD+x6x4nF2XLuylmrpuESksgA3l+4TqVt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.966.0/index.min.mjs": "sha384-v3YxE3TXkYFAsvFYjk7eWMGUdJ4VPvhDD+x6x4nF2XLuylmrpuESksgA3l+4TqVt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.966.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IDUa/WjmGnK6XpyilGUOEJOmjMt5lANBMB2Fi/w6oqxFE6Z5LEFQZ1GWIt7UY/Rx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.958.0/index.min.mjs": "sha384-IDUa/WjmGnK6XpyilGUOEJOmjMt5lANBMB2Fi/w6oqxFE6Z5LEFQZ1GWIt7UY/Rx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.958.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4MZpL08ROR/NhKa/pZsOYn1JBCdGaF3SJ+Nj14RwoZP5iYfWMkKm+X4HCEW/+gE1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.965.0/index.min.mjs": "sha384-4MZpL08ROR/NhKa/pZsOYn1JBCdGaF3SJ+Nj14RwoZP5iYfWMkKm+X4HCEW/+gE1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.965.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.939.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.939.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zeNpEXinVb8Qee51QfG3czEqVj18bDI+wJrbXKHhv8z0fxkSjOIbj7xgY9a0MOIi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.939.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.939.0/index.min.mjs": "sha384-zeNpEXinVb8Qee51QfG3czEqVj18bDI+wJrbXKHhv8z0fxkSjOIbj7xgY9a0MOIi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.939.0/LICENSE
```

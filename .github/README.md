...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UPC3WQPb1jRCbbzy/8G9MGgkhqTwsif0vbu1qkJPNMVH0xTumxXq1lgjF8eKZUv3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.947.0/index.min.mjs": "sha384-UPC3WQPb1jRCbbzy/8G9MGgkhqTwsif0vbu1qkJPNMVH0xTumxXq1lgjF8eKZUv3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.947.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pJrKOJPqTnWFFJFW/529hyVrVxsDI+eRqPno3xoTkq0+K3gzxfjhU9Ht2EbRfYcC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.933.0/index.min.mjs": "sha384-pJrKOJPqTnWFFJFW/529hyVrVxsDI+eRqPno3xoTkq0+K3gzxfjhU9Ht2EbRfYcC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.933.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d4XasyBnMpfj3Tsht4AG5O1RQEpZ1/L58pZaZbwSk/jba1Gw514t3bZaYmOO+6I0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.955.0/index.min.mjs": "sha384-d4XasyBnMpfj3Tsht4AG5O1RQEpZ1/L58pZaZbwSk/jba1Gw514t3bZaYmOO+6I0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.955.0/LICENSE
```

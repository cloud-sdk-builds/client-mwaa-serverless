...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/uSSlOIzHSTuDBog+xZ83fPoG1ZD1yg7lpMgtBdNOE9j2ZCCfeVkJV1vl+RqRh4o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.992.0/index.min.mjs": "sha384-/uSSlOIzHSTuDBog+xZ83fPoG1ZD1yg7lpMgtBdNOE9j2ZCCfeVkJV1vl+RqRh4o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.992.0/LICENSE
```

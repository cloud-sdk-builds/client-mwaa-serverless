...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cvjosTax0jyPnJ0tAjwYTClPCQynh/1zaOYsVzyDw+cYQbdTUYjsvZ4E2XsOTB4x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.978.0/index.min.mjs": "sha384-cvjosTax0jyPnJ0tAjwYTClPCQynh/1zaOYsVzyDw+cYQbdTUYjsvZ4E2XsOTB4x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.978.0/LICENSE
```

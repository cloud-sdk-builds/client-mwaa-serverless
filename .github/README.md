...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YnWD7PH8z7Jv1FWHJ7rJM9zgJ5SqdSVdLRrvDgdFHdltuKKemW70DxcY5ENHbyA6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.997.0/index.min.mjs": "sha384-YnWD7PH8z7Jv1FWHJ7rJM9zgJ5SqdSVdLRrvDgdFHdltuKKemW70DxcY5ENHbyA6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.997.0/LICENSE
```

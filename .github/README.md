...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DR0B5oSofjCyuGXkVeKFjfyi85iz+PMIFIXkB5gGBDv5ZW6DKehTFdnyNDnlChIO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.993.0/index.min.mjs": "sha384-DR0B5oSofjCyuGXkVeKFjfyi85iz+PMIFIXkB5gGBDv5ZW6DKehTFdnyNDnlChIO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.993.0/LICENSE
```

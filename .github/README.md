...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WhUk8XSA7iRtg8ktgfrLLL49ViED0FrqUtaZYOxvQZVmdu/W6wBM0/CgRdIcW9gD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.968.0/index.min.mjs": "sha384-WhUk8XSA7iRtg8ktgfrLLL49ViED0FrqUtaZYOxvQZVmdu/W6wBM0/CgRdIcW9gD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.968.0/LICENSE
```

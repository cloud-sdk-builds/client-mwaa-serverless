...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uy0nOZWFescR0T31OaVt2hYxdKmxA+i2A5BK+P5dSLfrrFryU8viwA5qBSRRFlP/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.994.0/index.min.mjs": "sha384-uy0nOZWFescR0T31OaVt2hYxdKmxA+i2A5BK+P5dSLfrrFryU8viwA5qBSRRFlP/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.994.0/LICENSE
```

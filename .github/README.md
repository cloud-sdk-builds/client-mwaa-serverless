...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-744ptjXfhCE5eKJVwFghBUuM6w2dRZOuLTjSINAolGq+nlw18cluUJHOEKYJesYA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.988.0/index.min.mjs": "sha384-744ptjXfhCE5eKJVwFghBUuM6w2dRZOuLTjSINAolGq+nlw18cluUJHOEKYJesYA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.988.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GShJuw0IJCJEAR+v/mahCFM3wnvSGrbi6U+psoelYbA/6rUe5TdoMOn5Rg8N4S/Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.982.0/index.min.mjs": "sha384-GShJuw0IJCJEAR+v/mahCFM3wnvSGrbi6U+psoelYbA/6rUe5TdoMOn5Rg8N4S/Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.982.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yOmZmigbm0KZ35PJrhupGfb2wRz5Y/i+c0BzH3kdOBe0zrHwE09yGVYAM5K5edSz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.986.0/index.min.mjs": "sha384-yOmZmigbm0KZ35PJrhupGfb2wRz5Y/i+c0BzH3kdOBe0zrHwE09yGVYAM5K5edSz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.986.0/LICENSE
```

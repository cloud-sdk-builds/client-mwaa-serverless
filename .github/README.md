...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.1019.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1019.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ht2+ar+ceYgeyohFDABH1NsrYBZ5jpzTeA/xlw1YEC/x0BlOiQugWtrxqSagjuvT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1019.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1019.0/index.min.mjs": "sha384-Ht2+ar+ceYgeyohFDABH1NsrYBZ5jpzTeA/xlw1YEC/x0BlOiQugWtrxqSagjuvT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.1019.0/LICENSE
```

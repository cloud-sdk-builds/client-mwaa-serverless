...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cO8zPwM3e9r5MMvCIVW//8IZWNIVVyKpAEGxdu6CRaDaP4yMTOYy/iptf7Pdiy2g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.991.0/index.min.mjs": "sha384-cO8zPwM3e9r5MMvCIVW//8IZWNIVVyKpAEGxdu6CRaDaP4yMTOYy/iptf7Pdiy2g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.991.0/LICENSE
```

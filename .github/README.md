...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W+eTm5XSVt2lypyPxjtQtVg/oWmYSryeGnlCyNVfPYTRxsasKMp+hSlZi6fnWtom
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.952.0/index.min.mjs": "sha384-W+eTm5XSVt2lypyPxjtQtVg/oWmYSryeGnlCyNVfPYTRxsasKMp+hSlZi6fnWtom"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.952.0/LICENSE
```

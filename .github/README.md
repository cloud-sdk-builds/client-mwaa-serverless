...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.1042.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1042.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CA0qCkJwTFjf3eToHkCS1x9IzVorqhMfb30gQizZUE3MnWLN6hNdtKiuZ44P5Fop
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1042.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1042.0/index.min.mjs": "sha384-CA0qCkJwTFjf3eToHkCS1x9IzVorqhMfb30gQizZUE3MnWLN6hNdtKiuZ44P5Fop"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.1042.0/LICENSE
```

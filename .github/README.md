...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wSa/Sg0XK2gp6GdLM2wHy7+UjOPcNVNT2+64v3wpwrIWy+SyeCTfpz2orb6JfMxX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.969.0/index.min.mjs": "sha384-wSa/Sg0XK2gp6GdLM2wHy7+UjOPcNVNT2+64v3wpwrIWy+SyeCTfpz2orb6JfMxX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.969.0/LICENSE
```

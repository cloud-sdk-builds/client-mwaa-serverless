...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tjY+JxJHD959twqg420UQymBxn5z+N7XgjVPtl15IKd4yfZBGYm1nixucH7pB5AM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.974.0/index.min.mjs": "sha384-tjY+JxJHD959twqg420UQymBxn5z+N7XgjVPtl15IKd4yfZBGYm1nixucH7pB5AM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.974.0/LICENSE
```

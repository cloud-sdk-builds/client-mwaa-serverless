...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.1023.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1023.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m/MHLE/e/wNclTn/C/eDBVmcI0+HjvxoY9fCtc5ni1Tn7Y/591LUg0DGw6tFrA6a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1023.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.1023.0/index.min.mjs": "sha384-m/MHLE/e/wNclTn/C/eDBVmcI0+HjvxoY9fCtc5ni1Tn7Y/591LUg0DGw6tFrA6a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.1023.0/LICENSE
```

...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UY4i77iaVuwA0fwkKfiytMhu3jZX5qT9J6/EHKLwWyNK6RQU3U3+iX9K41TwKCFm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.940.0/index.min.mjs": "sha384-UY4i77iaVuwA0fwkKfiytMhu3jZX5qT9J6/EHKLwWyNK6RQU3U3+iX9K41TwKCFm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.940.0/LICENSE
```

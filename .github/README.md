...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d3vYHlDSGwfAVHd76kMymnqrSsTieWhOptlJMuvxqhEtToD2ZFQ59y2N9pfYgSlF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.948.0/index.min.mjs": "sha384-d3vYHlDSGwfAVHd76kMymnqrSsTieWhOptlJMuvxqhEtToD2ZFQ59y2N9pfYgSlF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.948.0/LICENSE
```

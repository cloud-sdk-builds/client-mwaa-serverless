...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qw8tNm2AIQQVeYPyeiE+86hGANn2SPtT+tDYGVVi5jtfv1ZUCvvaXo6nlFlAdR9X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.996.0/index.min.mjs": "sha384-Qw8tNm2AIQQVeYPyeiE+86hGANn2SPtT+tDYGVVi5jtfv1ZUCvvaXo6nlFlAdR9X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.996.0/LICENSE
```

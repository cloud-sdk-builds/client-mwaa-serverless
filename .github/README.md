...
[`@aws-sdk/client-mwaa-serverless`](https://www.npmjs.com/package/@aws-sdk/client-mwaa-serverless/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DAVL+H8/DURifyAuMOxJbknIE7bSQHQ/qYfrYC7pFhDwgBmmp8zES5JO/6bMNGcZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa-serverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa-serverless@3.964.0/index.min.mjs": "sha384-DAVL+H8/DURifyAuMOxJbknIE7bSQHQ/qYfrYC7pFhDwgBmmp8zES5JO/6bMNGcZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa-serverless/blob/refs/tags/3.964.0/LICENSE
```
